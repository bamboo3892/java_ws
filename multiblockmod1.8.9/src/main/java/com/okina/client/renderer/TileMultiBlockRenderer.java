...
public class TileMultiBlockRenderer extends TileEntitySpecialRenderer {
	...
	@Override
	public void renderTileEntityAt(TileEntity tile, double tileX, double tileY, double tileZ, float partialTicks, int destroyStage) {
		...
		//			double ticks = tile.getWorld().getTotalWorldTime() + partialTicks;
