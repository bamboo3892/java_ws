...
public class ConstructStorageGui extends GuiContainer {
	...
	public ConstructStorageGui(IInventory invPlayer, IInventory invChest) {
		super(new ConstructStorageContainer(invPlayer, invChest));
	...
	protected void drawGuiContainerForegroundLayer(int p_146979_1_, int p_146979_2_) {
		fontRendererObj.drawString(I18n.format(upperChestInventory.getName(), new Object[0]), 8, 6, 4210752);
		fontRendererObj.drawString(I18n.format(lowerChestInventory.getName(), new Object[0]), 8, ySize - 96 + 2, 4210752);
	}
