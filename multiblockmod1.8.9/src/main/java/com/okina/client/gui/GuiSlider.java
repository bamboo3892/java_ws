...
public class GuiSlider extends GuiButton {
	...
	public void setValue(int value) {
		...
		this.drawTexturedModalRect(xPosition + (int) (ratio * (width - 8)), yPosition, 0, 66, 4, 20);
		this.drawTexturedModalRect(xPosition + (int) (ratio * (width - 8)) + 4, yPosition, 196, 66, 4, 20);
