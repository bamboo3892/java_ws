...
public class BlockFrameLineRenderer implements ISimpleBlockRenderingHandler {
	...
	public boolean renderWorldBlock(IBlockAccess world, int x, int y, int z, Block block, int modelId, RenderBlocks renderer) {
		...
		if(meta == 0){
			...
			renderer.renderStandardBlock(block, x, y, z);
			renderer.setOverrideBlockTexture(Blocks.redstone_block.getBlockTextureFromSide(0));
			renderer.setRenderBounds(2F/16F, 00.1F/16F, 2F/16F, 14F/16F, 15.99F/16F, 14F/16F);
			renderer.renderStandardBlock(block, x, y, z);
		}else if(meta == 2){
			...
			renderer.renderStandardBlock(block, x, y, z);
			renderer.setOverrideBlockTexture(Blocks.redstone_block.getBlockTextureFromSide(0));
			renderer.setRenderBounds(2F/16F, 2F/16F, 0.01F/16F, 14F/16F, 14F/16F, 15.99F/16F);
			renderer.renderStandardBlock(block, x, y, z);
		}else if(meta == 3){
			...
			renderer.renderStandardBlock(block, x, y, z);
			renderer.setOverrideBlockTexture(Blocks.redstone_block.getBlockTextureFromSide(0));
			renderer.setRenderBounds(0.01F/16F, 2F/16F, 2F/16F, 15.99F/16F, 14F/16F, 14F/16F);
			renderer.renderStandardBlock(block, x, y, z);
		}
		renderer.clearOverrideBlockTexture();
		return true;
