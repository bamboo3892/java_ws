...
public class InventoryHelper {
			...
			for (int slot : accessible){
				if(backSidedInv.getStackInSlot(slot) != null){
					...
					if(backSidedInv.canExtractItem(slot, item, startSide.ordinal())){
						if(InventoryHelper.tryPushItem(world, goal, goalSide, item, false)){
	...
	public static boolean tryPushItem(World world, IInventory goal, ForgeDirection side, ItemStack item, boolean simulate) {
