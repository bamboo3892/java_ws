...
public class ParticleTest1 extends EntityFX {
	...
	public ParticleTest1(World world, double endX, double endY, double endZ, double startX, double startY, double startZ) {
