...
public class GuiHandler implements IGuiHandler {
	...
	public Object getServerGuiElement(int ID, EntityPlayer player, World world, int x, int y, int z) {
		...
		case FILTER_GUI_ID_0:
			return new ConstructFilterContainer(player.inventory, (FilterInventory) ((ConstructFilterUserTileEntity) world.getTileEntity(x, y, z)).filter[0]);
		case FILTER_GUI_ID_1:
			return new ConstructFilterContainer(player.inventory, (FilterInventory) ((ConstructFilterUserTileEntity) world.getTileEntity(x, y, z)).filter[1]);
		case FILTER_GUI_ID_2:
			return new ConstructFilterContainer(player.inventory, (FilterInventory) ((ConstructFilterUserTileEntity) world.getTileEntity(x, y, z)).filter[2]);
		case FILTER_GUI_ID_3:
			return new ConstructFilterContainer(player.inventory, (FilterInventory) ((ConstructFilterUserTileEntity) world.getTileEntity(x, y, z)).filter[3]);
		case FILTER_GUI_ID_4:
			return new ConstructFilterContainer(player.inventory, (FilterInventory) ((ConstructFilterUserTileEntity) world.getTileEntity(x, y, z)).filter[4]);
		case FILTER_GUI_ID_5:
			return new ConstructFilterContainer(player.inventory, (FilterInventory) ((ConstructFilterUserTileEntity) world.getTileEntity(x, y, z)).filter[5]);
		case DESIGN_TABLE_GUI:
			return new DesignTableContainer(player.inventory, (BlockDesignTableTileEntity) world.getTileEntity(x, y, z), world);
		default:
			return null;
		}
	}
	...
	public Object getClientGuiElement(int ID, EntityPlayer player, World world, int x, int y, int z) {
		...
		case DESIGN_TABLE_GUI:
			return new DesignTableGui(player.inventory, (BlockDesignTableTileEntity) world.getTileEntity(x, y, z), world);
		default:
			return null;
		}
	}
