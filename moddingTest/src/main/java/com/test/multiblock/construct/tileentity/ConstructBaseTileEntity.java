...
public abstract class ConstructBaseTileEntity extends TileEntity implements ISimpleTilePacketUser {
	...
	public SimpleTilePacket getPacket(PacketType type) {
		if(type == PacketType.FLAG_IO){
			...
			return new SimpleTilePacket(xCoord, yCoord, zCoord, PacketType.FLAG_IO, str);
		}
		return null;
	}
	...
	public void markDirty() {
		super.markDirty();
		TestCore.proxy.markForTileUpdate(new Position(xCoord, yCoord, zCoord), PacketType.NBT_CONETENT);
	}
